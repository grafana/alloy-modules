...
| `label_selectors` | _no_     | `["app.kubernetes.io/name=gitlab-ci-pipelines-exporter"]` | The [label selectors](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/) to use to find matching targets          |
